...
import org.sakaiproject.mailtool.model.EmailEntry;
...
public class EmailBean
{
				...
				try
				{
					...
					for (InternetAddress addr : emailAddresses)
					{
						...
						if (addr.getPersonal() != null)
							addrStr = addr.getPersonal() + " <" + addr.getAddress() + ">";
						else
	...
	/**
	 * Add user to the email list and perform validation. Will not add "fromEmail" to the list.
	 * 
	 * @param fromEmail
	 * @param emailusers
	 * @param users
