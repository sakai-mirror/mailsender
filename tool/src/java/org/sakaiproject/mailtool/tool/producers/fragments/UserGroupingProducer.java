		...
		try
		{
			...
			else
			{
				for (int i = 0; i < emailRoles.size(); i++)
				{
					...
					command += "jQuery('#" + selectLink.getFullID() + "').hide();";
					command += "jQuery('#" + collapseLink.getFullID() + "', true).show();";
					...
					command = "jQuery('#" + collapseLink.getFullID() + ", #"
							+ usersArea.getFullID() + "').hide();";
					command += "jQuery('#" + selectLink.getFullID() + "').show();";
					command += "return false;";
