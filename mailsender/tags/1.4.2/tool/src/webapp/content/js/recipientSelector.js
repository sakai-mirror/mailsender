...
var RcptSelect = function()
{
	...
	return {
		 ...
		 * resultId: the id of the field where results should be placed after retrieval
		...
		showResults : function(link, resultId, isTLM)
		{
			...
			var resultArea = jQuery(_safeId('', resultId));
		...
		{
			RcptSelect.showResults(link, usersAreaId);
		...
		toggleSelectAll: function(checkboxId)
		{
			...
			jQuery('input[type=checkbox]:enabled', checkbox + ' ~ div:first').attr('checked', checked);
		},
