...
import org.sakaiproject.mailtool.model.ConfigEntry.ConfigParams;
import org.sakaiproject.mailtool.model.ConfigEntry.EditorType;
import org.sakaiproject.mailtool.model.ConfigEntry.ReplyTo;
import org.sakaiproject.mailtool.model.ConfigEntry.UserViewSelectType;
...
public class ConfigLogicImpl implements ConfigLogic
{
	...
	/**
	 * @see org.sakaiproject.mailtool.logic.ConfigLogic#useRichTextEditor
	 */
	...
	/**
	 * @see org.sakaiproject.mailtool.logic.ConfigLogic#getViewSelectType
	 */
...
//		props.remove("wysiwyg.editor");
	 ...
	 * 
	 * @param props
	 * @see org.sakaiproject.mailtool.model.ConfigEntry.EditorType
	 * @return
	 */
...
//		}
	 ...
	 * implementation of Mailtool used yes/no instead of sender/no_reply_to.  Rather than run a db
	 * conversion to the new values, the below checks are made to slowly migrate the data
	 * 
	 * @param props
	 * @see org.sakaiproject.mailtool.model.ConfigEntry.ReplyTo
	 * @return
	 */
	private String getReplyTo(Properties props)
	{
		String replyTo = (String) props.getProperty(ConfigParams.replyto.name());
		if ("yes".equalsIgnoreCase(replyTo) || ReplyTo.sender.name().equalsIgnoreCase(replyTo))
	 ...
	 * @param props
	 *            The tool config properties
	 * @see org.sakaiproject.mailtool.model.ConfigEntry.UserViewSelectType
	 * @return
	 */
	...
	/**
	 * The original implementation of Mailtool used yes/no instead of true/false, so rather than run
